...
export default function ToppersGalleryClient({ toppers }: ToppersGalleryClientProps) {
  ...
  return (
    <section id="results" className="relative overflow-hidden border-b-8 border-[#c52622] bg-[radial-gradient(circle_at_top,#142744_0%,#0a192f_45%,#070b13_100%)] py-20 sm:py-24">
        ...
        >
          {toppers.map((topper) => (
            ...
            >
              ...
              <div className="absolute right-0 top-0 flex h-20 w-20 items-start justify-end rounded-bl-3xl border-b-4 border-l-4 border-[#0a192f] bg-[#c52622] p-3 shadow-md">
                <Award className="h-8 w-8 text-amber-300" />
              </div>

              <div>
                <div className="relative z-20 mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border-4 border-amber-400 bg-[#0a192f] text-2xl font-black text-amber-300 shadow-[0_10px_25px_rgba(245,158,11,0.18)]">
                  #{topper.rank_position}
                </div>

                <div className="-mt-8 mb-6 flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border-4 border-[#c52622] bg-[#fff7df] shadow-inner mx-auto relative z-10">
                  <Image
                ...
                <h3 className="mb-2 text-2xl font-black uppercase tracking-tight text-[#0a192f] transition-colors group-hover:text-[#c52622]">
                  {topper.name}
                </h3>
                <p className="mb-8 text-sm font-bold uppercase tracking-widest text-[#c52622]">
                  {topper.stream}
                </p>
              </div>

              <div className="mt-auto rounded-2xl border-2 border-[#0a192f] bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 p-1 shadow-inner">
                <div className="rounded-xl bg-[#0a192f] px-2 py-4 text-center text-white">
